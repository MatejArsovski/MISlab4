...
class _AddEventScreenState extends State<AddEventScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Ново полагање'),
        backgroundColor: Colors.greenAccent, // Change AppBar color
      ),
      body: Form(
        key: _formKey,
        child: ListView(
          ...
          children: [
            TextFormField(
              ...
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return 'Внесете име на предмет';
                }
                return null;
              },
            ),
            SizedBox(height: 17.0), // Add spacing
            TextFormField(
            ...
            ListTile(
              ...
              trailing: Icon(Icons.access_time, color: Colors.greenAccent),
              onTap: () async {
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.greenAccent, // Change button color
